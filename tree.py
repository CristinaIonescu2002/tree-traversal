...
class Tree:
    ...
    def _printInorderTree(self, node):
        """ 
        Method for recursively printing the tree in order 
    ...
    def _printPreorderTree(self, node):
        """ 
        Method for recursively printing the tree in pre-order 
    ...
    def _printPostorderTree(self, node):
        """ 
        Method for recursively printing the tree in post-order 
